...
@section('content')
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div class="p-5 bg-blue-50/50 border border-blue-100 rounded-xl shadow-sm dark:bg-blue-900/10 dark:border-blue-900/20">
                <div class="flex items-center justify-between mb-2">
                    <p class="text-xs font-bold uppercase text-blue-600 dark:text-blue-400 tracking-wider">Menunggu TTD Final</p>
        ...
        <div class="bg-white border border-gray-200 rounded-2xl shadow-sm dark:bg-gray-800 dark:border-gray-700 overflow-hidden flex flex-col mb-8">
            <div class="px-5 py-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-700/30 flex justify-between items-center text-heading font-bold italic">
                <h3 class="flex items-center text-gray-900 dark:text-white font-black">
                    <i class="ti ti-penciling text-blue-600 me-2 text-xl"></i> Antrean Penandatanganan Kaban
                </h3>
            </div>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-10 text-center italic text-gray-400 dark:text-gray-500">
                                    Belum ada tiket yang memerlukan tanda tangan Anda.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
                    ...
                    <tbody class="divide-y divide-gray-50 dark:divide-gray-700/30">
                        @forelse($tiketHistory as $history)
                            <tr class="hover:bg-blue-50/30 dark:hover:bg-slate-700/40">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="{{ route('kaban.tiket.preview', $history->uuid) }}" target="_blank" class="text-blue-600 hover:underline font-bold text-xs">Download SKT</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
    ...
    <div id="modalTolakKaban" class="fixed inset-0 z-50 hidden bg-gray-900/60 backdrop-blur-sm overflow-y-auto h-full w-full items-center justify-center p-4">
        <div class="relative w-full max-w-lg bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 border border-gray-100 dark:border-gray-700">
            ...
            <form action="{{ route('kaban.tiket.proses', 'dummy') }}" id="formTolakKaban" method="POST">
                @csrf
