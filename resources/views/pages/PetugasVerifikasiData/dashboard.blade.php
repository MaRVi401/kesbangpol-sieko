...
@section('content')
    <div class="p-4 mt-14">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <div class="p-5 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                <div class="flex items-center justify-between mb-2">
                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Total Antrean Masuk</p>
            ...
            <div
                class="p-5 bg-orange-50 border border-orange-200 rounded-lg shadow-sm dark:bg-orange-900/10 dark:border-orange-900/30">
                <div class="flex items-center justify-between mb-2">
                    <p class="text-sm font-medium text-orange-600 dark:text-orange-400">Sedang Anda Tangani</p>
            ...
            <div
                class="p-5 bg-green-50 border border-green-200 rounded-lg shadow-sm dark:bg-green-900/10 dark:border-green-900/30">
                <div class="flex items-center justify-between mb-2">
            ...
            <div class="p-5 bg-red-50 border border-red-200 rounded-lg shadow-sm dark:bg-red-900/10 dark:border-red-900/30">
                <div class="flex items-center justify-between mb-2">
                    <p class="text-sm font-medium text-red-600 dark:text-red-400">Total Tiket Ditolak</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div
                class="lg:col-span-2 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700 overflow-hidden">
                <div
                    class="px-5 py-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/30 dark:bg-gray-700/30 flex justify-between items-center">
                    <h3 class="font-bold text-gray-900 dark:text-white flex items-center">
                        <svg class="w-5 h-5 me-2 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                        </svg>
                        Tiket di Halaman Kerja
                    </h3>
                    <span
                        class="text-xs font-medium px-2.5 py-0.5 rounded-full bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400">
                        {{ $recentTickets->count() }} Aktif
                    </span>
                </div>
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            @forelse($recentTickets as $rt)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/40 transition-all duration-200">
                                    <td class="px-6 py-4">
                                        <span
                                            class="font-mono font-bold text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 px-2 py-1 rounded">
                                            {{ $rt->no_tiket }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4">
                                ...
                                <tr>
                                    <td colspan="4" class="px-6 py-16 text-center">
                                        <div class="flex flex-col items-center">
                                            <svg class="w-12 h-12 text-gray-200 dark:text-gray-700 mb-3" fill="none"
                                                stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                                            </svg>
                                            <p class="text-gray-400 dark:text-gray-500 italic">Tidak ada tiket aktif di
                                                halaman kerja Anda.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
            ...
            <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-4">
                <h3 class="font-bold text-gray-900 dark:text-white mb-4">Statistik Penyelesaian Layanan</h3>
    ...
    @push('scripts')
        @vite('resources/js/dashboard-operator.js')
    @endpush
@endsection
