...
@section('content')
    <div class="p-4 mt-14">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div class="text-center md:text-left">
                    ...
                    <p class="mt-1 text-xs md:text-sm text-gray-500 dark:text-gray-400 font-medium">
                        Dashboard Pemohon Layanan Kesbangpol
                    </p>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <div class="p-5 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                <div class="flex items-center justify-between mb-2">
                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Total Diajukan</p>
            ...
            <div
                ...
                <div class="flex items-center justify-between mb-2">
                    <p class="text-sm font-medium text-green-600 dark:text-green-400">Total SKT Terbit</p>
            ...
            <div class="p-5 bg-red-50 border border-red-200 rounded-lg shadow-sm dark:bg-red-900/10 dark:border-red-900/30">
                <div class="flex items-center justify-between mb-2">
                    <p class="text-sm font-medium text-red-600 dark:text-red-400">Total Ditolak</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                ...
                                <tr>
                                    <td colspan="3" class="px-6 py-16 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-gray-400 dark:text-gray-500 italic">Anda belum mengajukan tiket layanan.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
            ...
            <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-4">
                <h3 class="font-bold text-gray-900 dark:text-white mb-4">Statistik Pengajuan Layanani</h3>
    ...
    @push('scripts')
        @vite('resources/js/dashboard-pemohon.js')
    @endpush
@endsection