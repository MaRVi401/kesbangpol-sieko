...
@section('content')
    ...
    <header id="beranda"
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row items-center gap-10 md:gap-12">
            ...
            <div class="w-full lg:w-1/2 text-center lg:text-left order-2 lg:order-1">
                ...
                <p
                    ...
                    Sistem Informasi dan Kesiapan Organisasi Kemasyarakatan Terintegrasi Kabupaten Subang. Memudahkan
                    pendaftaran Ormas serta permohonan Surat Rekomendasi Penelitian Online secara aman.
                </p>
        ...
        <div
            class="absolute top-0 right-0 -mr-20 -mt-20 w-64 h-64 md:w-96 md:h-96 bg-red-600 bg-opacity-10 dark:bg-red-500 dark:bg-opacity-10 rounded-full blur-3xl opacity-40 pointer-events-none">
        </div>
        <div
            class="absolute bottom-0 left-0 -ml-20 -mb-20 w-64 h-64 md:w-96 md:h-96 bg-blue-600 bg-opacity-5 dark:bg-blue-500 dark:bg-opacity-5 rounded-full blur-3xl opacity-30 pointer-events-none">
        </div>
    </header>
                ...
                @php
                    $steps = [
                        [
                            ...
                            'desc' =>
                                'Buat akun pemohon menggunakan email aktif untuk melacak berkas secara real-time.',
                        ],
                        [
                            'no' => 2,
                            'title' => 'Isi Formulir',
                            'desc' =>
                                'Lengkapi dokumen profil dan unggah berkas persyaratan sesuai modul layanan Anda.',
                        ],
                        [
                            'no' => 3,
                            'title' => 'Verifikasi Berkas',
                            'desc' =>
                                'Tim penilai internal Kesbangpol memproses keabsahan berkas & melakukan cek lapangan.',
                        ],
                        [
                            'no' => 4,
                            'title' => 'Unduh Dokumen',
                            'desc' =>
                                'Jika disetujui, Surat Rekomendasi/Tanda Lapor resmi langsung diterbitkan secara digital.',
                        ],
                    ];
                @endphp
    ...
    <!-- Section Berita -->
    <section id="berita"
        class="py-16 md:py-24 bg-gray-50 dark:bg-gray-900/50 transition-colors duration-300 border-t dark:border-gray-800">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
